...
public class WaylineView extends View {
    ...
    public WaylineView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        if(mMarker == null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mMarker = mContext.getDrawable(R.drawable.timeline_marker);
            } else {
    ...
    public void initLine(int viewType) {
        ...
        if(viewType == Constants.BEGIN) {
            setStartLine(null);
        } else if(viewType == Constants.END) {
            setEndLine(null);
        } else if(viewType == Constants.ONLYONE) {
            setStartLine(null);
            setEndLine(null);
        }
