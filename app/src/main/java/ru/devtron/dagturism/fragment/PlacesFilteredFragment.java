...
public class PlacesFilteredFragment extends Fragment {
    private final static String ITEMS_COUNT_KEY = "PlacesFilteredFragment$ItemsCount";
    ...
    public static PlacesFilteredFragment createInstance(int itemsCount, String city, String rest){
